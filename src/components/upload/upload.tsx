...
export default function Upload() {
    ...
    return (
        <div className="max-w-2xl mx-auto mb-8">
            <div
                className="relative border-2 border-dashed border-gray-300 hover:border-violet-400 hover:bg-white rounded-2xl p-12 text-center cursor-pointer transition-all dark:border-[#4c3d5f] dark:hover:border-[#7c3aed] dark:hover:bg-[#251a35]"
                onClick={handleClick}
            ...
            >
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div>
                        <p className="text-xl font-semibold text-gray-700 dark:text-[#8b7fb8] mb-2">
                            Drop your image here
                        </p>
                        <p className="text-gray-500 dark:text-[#b4a7d6]">or click to browse</p>
                    </div>
